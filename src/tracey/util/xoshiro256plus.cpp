...
/* This code was extended for C++. For the original code,
...
uint64_t Xoshiro256Plus::max() {return 0xffffffffffffffff;}


void Xoshiro256Plus::seed(uint64_t seed_a, uint64_t seed_b, uint64_t seed_c, uint64_t seed_d) {
	s[0] = seed_a;
	s[1] = seed_b;
	s[2] = seed_c;
	s[3] = seed_d;
...
uint64_t Xoshiro256Plus::next(void) {
...
void Xoshiro256Plus::long_jump(void) {
